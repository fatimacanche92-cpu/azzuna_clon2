    ...
    switch (eventType) {
      case 'aniversario':
        return AIRecommendation(
          suggestedMessage:
              'Tu cliente $clientName celebrará su aniversario. ¡Sorpréndelo!',
      ...
      case 'cumpleaños':
        return AIRecommendation(
          suggestedMessage:
              'El cumpleaños de $clientName se acerca. ¡Es hora de celebrar!',
      ...
      case 'navidad':
        return AIRecommendation(
          suggestedMessage:
              '$clientName suele comprar en Navidad. Envíale tus promociones de temporada.',
      ...
      case 'san valentín':
        return AIRecommendation(
          suggestedMessage:
              'El día de San Valentín es ideal para recordar a $clientName sobre tus arreglos.',
      ...
      case 'día de las madres':
        return AIRecommendation(
          suggestedMessage:
              'Recuérdale a $clientName que tienes el regalo perfecto para el Día de las Madres.',
