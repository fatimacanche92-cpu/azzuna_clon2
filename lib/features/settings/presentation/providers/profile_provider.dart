...
class ProfileState {
  ...
  ProfileState copyWith({
    ...
    final newNotificationsEnabled =
        notificationsEnabled ?? this.notificationsEnabled;

    return ProfileState(
      profile:
          profile ??
          this.profile?.copyWith(notificationsEnabled: newNotificationsEnabled),
...
class ProfileNotifier extends StateNotifier<ProfileState> {
  ...
  Future<void> updateProfilePicture() async {
    try {
      ...
      if (pickedFile != null) {
        ...
        final tempProfile = state.profile!.copyWith(
  ...
  void toggleNotifications(bool isEnabled) {
    if (state.profile != null) {
      ...
      state = state.copyWith(
        notificationsEnabled: isEnabled,
      ); // Also update ProfileState's own property
      updateUserProfile(
        updatedProfile,
      ); // This will update the profile in the service and then re-set the state
    }
  }
}
